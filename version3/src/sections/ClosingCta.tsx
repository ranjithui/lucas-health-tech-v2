  ...
  return (
    <section className="relative overflow-hidden bg-field pb-16 pt-20 text-white md:pb-20 md:pt-28 dark:border-t dark:border-white/[0.08]">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(60% 60% at 50% 100%, rgba(255, 255, 255, 0.14), transparent 65%)' }}
      />
      <div
        aria-hidden
        className="absolute inset-0 hidden dark:block"
        style={{ background: 'radial-gradient(60% 60% at 50% 100%, rgba(31, 78, 140, 0.16), transparent 65%)' }}
      />
