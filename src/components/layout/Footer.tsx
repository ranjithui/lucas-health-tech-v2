...
const columns = [
  {
    heading: 'Solutions',
    links: solutions.map((s) => ({ label: s.title, to: `/solutions/${s.id}` })),
  },
  {
    heading: 'Industries',
    links: industries.map((i) => ({ label: i.title, to: `/industries/${i.id}` })),
  },
  {
    heading: 'Company',
    links: [
      ...
      <div className="container-x">
        <div className="grid gap-14 border-b border-white/30 pb-16 pt-16 md:grid-cols-[1.3fr_repeat(3,1fr)] md:gap-10">
          <div>
            ...
            <p className="mt-6 max-w-xs text-[14.5px] leading-[1.6] text-white">
              Clinical strategy, technology, operations, and innovation — connected.
            </p>
            <a
        ...
        <div className="grid gap-6 border-b border-white/30 py-10 text-[14px] text-white sm:grid-cols-3">
          <div>
            <span className="block font-mono text-[10.5px] uppercase tracking-[0.2em] text-white/80">Phone</span>
          ...
          <div>
            <span className="block font-mono text-[10.5px] uppercase tracking-[0.2em] text-white/80">Hours</span>
