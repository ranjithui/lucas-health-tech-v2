...
const TREATMENT = {
  dark: {
    ...
    bloom:
      'radial-gradient(70% 55% at 78% 28%, rgba(31, 78, 140, 0.22), transparent 62%), radial-gradient(50% 45% at 8% 88%, rgba(59, 110, 168, 0.08), transparent 60%)',
  ...
  light: {
    ...
    bloom:
      'radial-gradient(70% 55% at 78% 28%, rgba(59, 110, 168, 0.14), transparent 62%), radial-gradient(58% 50% at 6% 86%, rgba(255, 255, 255, 0.85), transparent 64%)',
